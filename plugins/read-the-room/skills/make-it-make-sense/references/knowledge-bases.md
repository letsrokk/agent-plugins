...
- Use concrete verbs: "validate the token" is clearer than "perform token validation." Keep connecting words when they establish a dependency: "After the backup completes, restart the service."
...
- Use respectful terminology and examples without unnecessary assumptions about readers. Use literal wording for instructions in international documentation; explain necessary domain terms rather than silently renaming code or product identifiers.
